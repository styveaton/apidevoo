...
use App\Entity\Vitrine\MetaDescription;
...
class MetaDescriptionRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(MetaDescription $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(MetaDescription $entity, bool $flush = true): void
    {
